...
export const ExamData: ExamEntry[] = [
  {
    ...
    altText: `Darcy entering the Einstein-Rosen Bridge set up by the crew`,
  },
  {
    // 1
  ...
  },
  {
    ...
    altText: `Bob Berney talking to Joe Bob and Darcy about his career`,
  },
  {
    // 3
  ...
  },
  {
    ...
    answer: `Jennifer had a heart condition called a mitral valve prolapse in "Dr. Giggles". A mitral valve prolapse is where the flaps of the mitral valve bulge into the left atrium during a heartbeat.`,
  ...
  },
  {
    ...
    altText: `The Last Drive-In Summer School interstitial graphic`,
  },
  {
    // 10
    question: `Essay #1: Explain the importance of Grandma Death in "Donnie Darko": `,
    ...
    Second, she's just an interesting character a merit to the movie, and also adds to the mystery about what Donnie experiencing. Her appearance is strange, and her behavior is odd and often unpredictable. She's not antagonistic, but there is still something slightly chilling about her. At the same time, the name "Grandma" implies a kind of maternal characterization. She could possibly help Donnie if he can gather the courage to speak with her, or she might just start babbling nonsense.
    Finally, she serves as a grim reminder that death comes for everyone, and that "everyone dies alone." Donnie is able to relate to that sentiment by remembering his dog that passed after crawling into a secluded place to die. While this is meaningful to Donnie the character, the audience can see that Grandma Death looks to be close to being on deaths door, and is quite alone. Donnie's ultimate fate is also in line with this. He realizes he has to sacrifice himself for the greater good of his friends and family at the end of the movie, and dies alone in that knowledge.`,
    altText: `Grandma Death from "Donnie Darko"`,
  },
  {
    // 11
    question: `Essay #2: Speculate as to why director Joe Lynch changed the main characters in H.P. Lovecraft's story from male to female: `,
